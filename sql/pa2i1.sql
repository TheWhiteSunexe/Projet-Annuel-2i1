...
--
-- Hôte : localhost:3307
-- Généré le : lun. 28 avr. 2025 à 03:43
...
CREATE TABLE `application` (
  ...
  `active` enum('pending','selected','refused') DEFAULT 'pending'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 1, 3, '10.00', 'pending'),
(3, 16, 5, '5.00', 'pending'),
(21, 18, 2, '1300.00', 'pending'),
(22, 19, 1, '2000.00', 'pending'),
(23, 19, 2, '2500.00', 'pending'),
(24, 20, 1, '3000.00', 'pending');
...
INSERT INTO `clients` (`id`, `id_user`, `name`, `siret`, `legal_form`, `activity_sector`, `phone`, `link`, `address`, `postal_code`, `country`, `description`, `active`) VALUES
(1, 2, 'esgi', '0', '', '', '0', '', '', '0', '', NULL, 1),
(2, 22, 'Entreprise Test', '12345678', 'SARL', 'Informatique', '123456789', 'https://entreprise-test.com', '123 Rue du Test, 75001 Paris', '75001', 'France', NULL, 0),
(3, 23, 'EDF', '10256348', 'SAS', 'Energie', '783091529', 'https://edf.fr', '7 allee du bois des Chenes', '94370', 'France', NULL, 1),
(5, 25, 'ESGI', '10256348', 'SAS', 'Ecole', '754545454', 'https://esgi.fr', 'Boulevard st antoine', '7012', 'France', NULL, 1),
(6, 26, 'NaTran', '0123456789', 'SARL', 'Energie', '0147852369', 'https://www.youtube.com', 'Clever', '75003', 'France', 'Gestion des apports en gaz', 1),
(7, 28, 'ABC Corp', '123456789', 'SAS', 'Informatique', '623456789', 'https://abccorp.com', '15 avenue des Champs', '75008', 'France', NULL, 0),
(8, 59, 'Posca', '1523647', 'SAS', 'feutre', '0792153684', 'https://posca.fr', '34 boulevard St martin, Nancy', '54700', 'France', NULL, 1),
(9, 62, 'Toshiba', 'fr125865', 'SNC', 'Electronique', '0625314852', 'https://toshiba.com', '54 rue boulevard François, Nogent sur marnes', '94', 'France', NULL, 1);
...
INSERT INTO `contracts` (`id`, `name`, `date`, `id_client`, `id_provider`, `id_event`, `title`, `content`, `complain`, `price`, `id_application`, `pay_status`, `file`, `id_room`, `publication`, `status`, `active`) VALUES
(1, 'contrat esgi 2025', '2025-01-30', 1, 3, NULL, 'test', 'contenu', NULL, 10, 1, NULL, 'chaipas', NULL, 1, 6, 1),
(15, 'test', '2025-03-25', 1, NULL, 3, 'linux', 'cours', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 0),
(16, 'devis n1', '2025-03-25', 1, NULL, NULL, 'demande de cours de linux', 'aze', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, 1),
(17, 'Devis n2', '2025-03-25', 1, NULL, NULL, 'Demande de cours de piano', 'Cours de piano ?', NULL, NULL, NULL, NULL, NULL, NULL, 0, 1, 1),
(18, 'Devis ESGI/BC 03/2025', '2025-03-29', 1, 2, 4, 'Cours de yoga du rire', 'Nous aimerions avoir un prof de yoga du rire pour donner des cours dans notre entreprise', NULL, 1300, 21, NULL, NULL, NULL, 1, 5, 2),
(19, 'Devis n3', '2025-03-29', 1, 2, 5, 'TeamBuilding pour 30 personnes', 'Un teambulding autour d\'un escape game ou tout autre jeu', NULL, 2500, 23, NULL, NULL, NULL, 1, 4, 2),
(20, 'Devis 4', '2025-04-01', 1, 1, 6, 'karting', 'Devis pour mettre en place et gérer un event de kart', NULL, 3000, 24, NULL, NULL, NULL, 1, 5, 2),
(21, 'chill', '2025-04-09', 1, NULL, 7, 'Netflix and chill', 'mettre en place un event pour 30p pour regarder netflix', NULL, NULL, NULL, NULL, NULL, NULL, 1, 3, 2);
...
INSERT INTO `employees` (`id`, `id_enterprise`, `id_employees`, `phone`, `link`, `status`) VALUES
(1, 1, 4, '', '', 1),
(2, 1, 64, NULL, NULL, 1);
...
(3, 15, 1, 'linux', 'cours', '2025-03-30', '2025-03-30', '16:38:00', '18:38:00', 1, NULL, 0),
(4, 18, 1, 'Cours de yoga du rire', 'Nous aimerions avoir un prof de yoga du rire pour donner des cours dans notre entreprise', '2025-04-02', '2025-04-02', '10:00:00', '11:30:00', 2, NULL, 0),
(5, 19, 1, 'TeamBuilding pour 30 personnes', 'Un teambulding autour d\'un escape game ou tout autre jeu', '2025-04-14', '2025-04-14', '15:30:00', '16:30:00', 4, NULL, 0),
(6, 20, 1, 'karting', 'Mettre en place et gérer un event de kart', '2025-04-30', '2025-04-30', '11:00:00', '14:30:00', 4, NULL, 1),
(7, 21, 1, 'Netflix and chill', 'mettre en place un event pour 30p pour regarder netflix', '2025-04-23', '2025-04-23', '18:30:00', '20:00:00', 2, NULL, 0);
...
INSERT INTO `providers` (`id`, `user_id`, `company_name`, `siret`, `phone`, `service_type`, `service_description`, `address`, `postal_code`, `country`, `vat_number`, `link`, `cv`, `active`) VALUES
(1, 3, 'teryuio', 152475, 330564815, 'Gestion d\'évènements', 'création et gestion d\'évènements pour entreprise, teambulding ...', '8 boulevard de bercy', 75003, 'France', 'FR21459', '', 'Tristan.pdf', 1),
(2, 43, 'MD Créations', 98765432, 612345678, 'Musique', 'Création de logos, identités visuelles et supports de communication.', '15 avenue des Arts', 75002, 'France', 'FR987654321', 'https://mdcreations.fr', NULL, 1),
(3, 44, 'b', 10, 10, 'b', 'bb', 'b', 10, 'b', '10', 'b', NULL, 1),
(4, 60, 'a', 1, 10, 'a', 'a', '1', 10, 'fr', '1', 'https://a', NULL, 1),
(5, 61, 'ChiLeChat', 123456789, 792153684, 'chat ', 'louer un chat gris', '34 rue yamagoshi Tokyo', 68, 'Japon', 'JP15238', 'https://chi.com', NULL, 1),
(6, 63, 'Genshin', 12569, 765314829, 'combat', 'Tabassages organisé', 'Lieu dit du Manoir hanté', 0, 'NuPart', 'CH457826', 'https://genshin.com', NULL, 1);
...
INSERT INTO `users` (`id`, `name`, `firstname`, `username`, `email`, `image`, `password`, `token`, `expiration`, `id_clients`, `id_providers`, `id_employees`, `id_admin`, `active`) VALUES
(1, 'Gillet', 'Tristan', 'tgillet', 'gillet.tristan.94@gmail.com', NULL, 'ac16704bb7d18d564c0ebb7b71d63dbeb0f382d6cae62639260396123fe9b83fb3a1c0aa0e34565093961dc5d300b6dffe8750ef2a28f23227a0d5683cf5b13e', '2fec023c1e0076c37fc3bb5856fb6335', '2025-04-09', NULL, NULL, NULL, 1, 1),
(2, 'Prisset', 'Noah', 'nprisset', 'prisset.noah@gmail.com', NULL, '99daaf3bb118dbb61a880fc2885f2c4d41fd6cfef8ddfba94366b92bd4eabc5621185282949579568dee4720d41cc7a09b9fd0d52d7fa86acfdebdbf3e78916d', '434cb72bb11a39122ef25a9ab8da5aa0', '2025-04-09', 1, NULL, NULL, NULL, 1),
(3, 'Alexandre ', 'Boudinar', 'aboudinar', 'abdoudinar@gmail.com', NULL, 'd742c1e8c6c10536427392b22e0922e9517118595536c458957cea2c81d1d10f7d370d21f020b64fd7ec68c79da4567c2ae03686f261cee21a20f4d191744bd1', '5f79dc4e4a4ade691e5375ca28633db3', '2025-04-08', NULL, 1, NULL, NULL, 1),
(4, 'Liss', 'Julien', 'jliss', 'jliss@gmail.com', 'profile_4_1742293522.jpg', 'd20b9f0f90dfc68c4408aa21e4ba530e26810e0473b06be8ebbe64c29cd279719131ceafc782762bbeef5d9692fec52fb9f38725aa47a91a884900c1311c7d1f', 'f63bf036c0957b9a19eafc4fdea8d593', '2025-04-08', NULL, NULL, 1, NULL, 1),
(22, 'Doe', 'John', NULL, 'test@example.com', NULL, '5a6e62af036cb861088a081b3e3dc9257ab34c28de08714dbb1dabe52abd68ee570244496013e9908f18ef651804e9ddace8d7a1def401c4b9e95b862f77febe', NULL, NULL, NULL, NULL, NULL, NULL, 0),
(23, 'Gillet', 'Sabine', 'sgillet', 'sabine.gillet@gmail.com', NULL, '8c3ce1a2f2b0df6a8be04c6c92ca75fdae52dfb8ffb67661c23ec2f1f2cc872146cf53ee4093e5dd8fb7a94192240955adcc8decb5c703bed75598c5c5a34ba5', '58b7f2a6a62ff699c097b1b1215b6ce7', '2025-03-10', 3, NULL, NULL, NULL, 1),
(25, 'Sananes', 'Frédérique', NULL, 'Fsananes@gmail.com', NULL, '53b7e949c41c96d9d71f4b6c42d208b779f628b141f3ce7654f9955d0c04097d861cde17097569a0b03a5d4a421066a7a58a0ecae6015679e92fa596f544f5d9', NULL, NULL, 5, NULL, NULL, NULL, 1),
(26, 'Gillet', 'Xavier', 'xgillet', 'xgillet@gmail.com', 'profile_26_1742147124.png', '85417adbbb09092c8ba1087399c43d6e235d40bb3887644775fe6292dd9a40952ba2f78181ed14dedac9e013f524e057137de90216452d44b9b2bb9634bb813a', '05a80f1d77e3c06cc534274887584bd0', '2025-03-16', 6, NULL, NULL, NULL, 1),
(28, 'Dupont', 'Marie', 'mdupont', 'marie.dupont@abccorp.com', NULL, '71ecbc46b1ba23825da0aeae61a322d373f9df138171566853d15e2444c5dfda89164af51290f8c45cd2e0f9bcbedbddf6094e0f3e8dc6133cf7b8c99243d180', NULL, NULL, 7, NULL, NULL, NULL, 1),
(43, 'Sanson', 'Véronique', 'svéronique', 'Véronique.sanson@example.com', 'profile_43_1742138976.png', '80d94b6f8f6d2a01ef88155dac311439cfe258a24458e244da9193120125b1fdcbac1fa525f870a0d9fc3517178e8c0fba50bb415d940fc57b62966314b5fc70', '3d0f5d9b550c79acd0afce904e4f9557', '2025-04-09', NULL, 2, NULL, NULL, 1),
(44, 'b', 'b', 'vsanson', 'b@gmail.com', NULL, '80d94b6f8f6d2a01ef88155dac311439cfe258a24458e244da9193120125b1fdcbac1fa525f870a0d9fc3517178e8c0fba50bb415d940fc57b62966314b5fc70', 'fcf4dceb3787a0a4ab54296b1bfaa0f7', '2025-03-16', NULL, 3, NULL, NULL, 0),
(59, 'Ducoste', 'Thibault', 'tducoste', 'Dthib@gmail.com', NULL, 'df6b9fb15cfdbb7527be5a8a6e39f39e572c8ddb943fbc79a943438e9d3d85ebfc2ccf9e0eccd9346026c0b6876e0e01556fe56f135582c05fbdbb505d46755a', NULL, NULL, 8, NULL, NULL, NULL, 1),
(60, 'a', '1', '1a', 'a@gmail.com', NULL, '3c9909afec25354d551dae21590bb26e38d53f2173b8d3dc3eee4c047e7ab1c1eb8b85103e3be7ba613b31bb5c9c36214dc9f14a42fd7a2fdb84856bca5c44c2', NULL, NULL, NULL, 4, NULL, NULL, 1),
(61, 'Yamada', 'Chi', 'cyamada', 'chiYamada@gmail.com', NULL, '94ce57d3f40928c60f063d1369cb0d8335472d50a3651760ef449a499412ccda7b74f90894e44e8ec6195d7b5903d85b170a64fdb66d37c00118232538971366', NULL, NULL, NULL, 5, NULL, NULL, 1),
(62, 'Tabari', 'Viviane', 'vtabari', 'Vtabari@gmail.com', NULL, '91393966083c26c5783ac6ae2fc6aa29c2764707e3f2d70db20ac1e5e15c4ff6618874cf7c6d4401badb51abbc61feb7533913127d1a01619abf15bf9ecbc687', NULL, NULL, 9, NULL, NULL, NULL, 1),
(63, 'Impact', 'Aether', 'aimpact', 'aether@gmail.com', NULL, '0add0fd93779c9dd18d2bec96cf8258b74509e0864f967f874e1a8ce8a7e5462d2fe3dac1d9790cc7292a879029587129ccf67be4c6e02e1a7207106f7fb4b6d', NULL, NULL, NULL, 6, NULL, NULL, 1),
(64, 'Chappell', 'Roan', NULL, 'CRoan@gmail.com', NULL, '$2y$10$IGE7SH1blq9/jNjFDpuD7.yKAIRalqHryIErG/6pGaW2zrMr2EdFe', NULL, NULL, NULL, NULL, 1, NULL, 1);
...
ALTER TABLE `employees`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_id_employees` (`id_employees`),
...
--
ALTER TABLE `employees`
  ADD CONSTRAINT `fk_id_employees` FOREIGN KEY (`id_employees`) REFERENCES `users` (`id`),
