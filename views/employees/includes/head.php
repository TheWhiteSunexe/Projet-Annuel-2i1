<head>    
    ...
    <link rel="stylesheet" href="/Projet-Annuel-2i1/PA2i1/assets/calendar/fonts/icomoon/style.css">
    <link href='/Projet-Annuel-2i1/PA2i1/assets/calendar/fullcalendar/packages/core/main.css' rel='stylesheet' />
    <link href='/Projet-Annuel-2i1/PA2i1/assets/calendar/fullcalendar/packages/daygrid/main.css' rel='stylesheet' />
    
    <link href='/Projet-Annuel-2i1/PA2i1/assets/style/overviewReview.css' rel='stylesheet' />

    <link rel="stylesheet" href="/Projet-Annuel-2i1/PA2i1/assets/calendar/css/bootstrap.min.css">
    <link rel="stylesheet" href="/Projet-Annuel-2i1/PA2i1/assets/calendar/css/style.css">
    <link rel="stylesheet" type="text/css" href="/Projet-Annuel-2i1/PA2i1/assets/css/style_agenda.css">
    ...
    <link rel="stylesheet" href="../../assets/styles/style_event.css">
    <!-- Faudrait trouver autre chose pour les href car les ../../ c'est relou-->
    <!-- Pour le calendrier  -->
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
    <link rel="stylesheet" type="text/css" href="/Projet-Annuel-2i1/PA2i1/assets/styles/style_forum.css">
</head>