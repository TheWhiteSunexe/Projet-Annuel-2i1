                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form id="updateForm">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                      <small><font color="red">*</font>Certaines informations ne peuvent pas être modifiées car elles ont été entrées par votre entreprise</small>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="linkedin" type="text" class="form-control" id="linkedin-update" >
                      </div>
                    </div>
