...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="Newsletter.php">
      <i class="bi-box-arrow-in-right"></i>
      <span>Newsletters</span>
    </a>
  </li>
  <li class="nav-item">
    <a class="nav-link collapsed" href="backnewsletter.php">
      <i class="bi-box-arrow-in-right"></i>
      <span>Logs des newsletters</span>
    </a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-heading">Elements pour Bootstrap</li>
  <li class="nav-item">
    <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
      <i class="bi bi-menu-button-wide"></i><span>Composants</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
    <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      <li>
        <a href="components-alerts.php">
          <i class="bi bi-circle"></i><span>Alertes</span>
        </a>
      </li>
      <li>
        <a href="components-accordion.php">
          <i class="bi bi-circle"></i><span>Accordéons</span>
        </a>
      </li>
      <li>
      ...
      <li>
        <a href="components-breadcrumbs.php">
          <i class="bi bi-circle"></i><span>Arbres</span>
        </a>
      </li>
      <li>
        <a href="components-buttons.php">
          <i class="bi bi-circle"></i><span>Bouttons</span>
        </a>
      </li>
      <li>
        <a href="components-cards.php">
          <i class="bi bi-circle"></i><span>Cartes</span>
        </a>
      </li>
      <li>
      ...
      <li>
        <a href="components-modal.php">
          <i class="bi bi-circle"></i><span>Fenêtres</span>
        </a>
      </li>
      <li>
      ...
      <li>
        <a href="components-progress.php">
          <i class="bi bi-circle"></i><span>Progression</span>
        </a>
      </li>
      <li>
        <a href="components-spinners.php">
          <i class="bi bi-circle"></i><span>Logo d'attente</span>
        </a>
      </li>
      <li>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
      <i class="bi bi-gem"></i><span>logos</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
