...
<body>
  ...
  <div class="pagetitle">
    ...
    <form action="download-backend.php" method="post">
        <button class="btn btn-primary profile-button" type="submit"><i class="bi-download"></i> Télécharger les Utilisateurs</button>
    </form>
    <div id="result">
  ...
  <script src="/Projet-Annuel-2i1\PA2i1\views\admin\back\js\users.js"></script>
