...
<body style="background-color: #EBF2FA;">
  ...
  <main id="main" class="main">
    <div class="pagetitle">
        <h1>Suivi des Evenements</h1>
        <nav>
        <ol class="breadcrumb" style="background-color: #EBF2FA;">
    ...
    <script src="/Projet-Annuel-2i1/PA2i1/views/admin/back/js/calendar.js" defer></script>
